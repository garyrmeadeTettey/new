...
const Teacher = () => {
  return (
    ...
    <div>
        ...
        <div className="mx-auto mt-24 mb-20 mt-4 max-w-6xl text-center p-3">

            <CardTitle className="text-2xl font-bold text-center">EXPLORE 500+ ONLINE</CardTitle>
            <CardDescription className="text-center">Free courses.</CardDescription>
