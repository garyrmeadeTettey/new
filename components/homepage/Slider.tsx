...
const Slideshow = () => {
    ...
    return (
        <div className="dark:bg-gray-950 flex justify-center items-center max-w-80 bg-opacity-50 bg-white rounded-md mt-14 p-[18%]">
          {imageData.map((data, index) => (
            ...
            >
              ...
              <p>{data.paragraph}</p>
              <Link href='/courses'>
                <Button className='mt-4 dark:hover:bg-gray-700 hover:bg-gray-500'>Learn more!</Button>
              </Link>
            </div>
          ))}
        </div>
