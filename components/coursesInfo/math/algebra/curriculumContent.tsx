...
const CurriculumContent = () => {
  ...
  const cardStyle = 'border border-gray-300 p-2 mb-2 cursor-pointer relative w-96 bg-white';
  ...
  const weekStyle = 'font-bold flex items-center bg-white';
        ...
        <div className={contentStyle}>
          <div className={contentItemStyle}>
            ...
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Reading: Variables & Expressions</p>
              <p className={contentDurationStyle}>14 minutes</p>
          ...
          <div className={contentItemStyle}>
            ...
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Video: Solving Equations</p>
              <p className={contentDurationStyle}>15 minutes</p>
            </div>
          </div>
          <div className={contentItemStyle}>
